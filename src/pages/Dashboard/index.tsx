...
export type FoodPropsFrom = Omit<FoodProps, 'id' | 'available'>
...
export const Dashboard = () => {
  ...
  const handleAddFood = async (food: FoodPropsFrom) => {
    try {
  ...
  return (
    <>
      ...
      <FoodsContainer data-testid="foods-list">
        {foods &&
          foods.map(food => (
            <Food key={food.id} available={food.available} food={food} handleDelete={handleDeleteFood} handleEditFood={handleEditFood} />
          ))}
      </FoodsContainer>
    </>
  )
